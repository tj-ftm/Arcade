...
export const ChessStartScreen = ({ onStartGame, onGoToMenu, onStartMultiplayer, onStartBetting }: ChessStartScreenProps) => {
  return (
    <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex flex-col items-center justify-center gap-4 animate-fade-in rounded-xl z-50 p-4 sm:p-6 md:p-8">
      {/* Game Title */}
