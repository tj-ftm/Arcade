    ...
    <div className="absolute inset-0 bg-purple-800 bg-gradient-to-br from-purple-900 via-purple-700 to-indigo-900 flex flex-col items-center justify-center gap-4 animate-fade-in rounded-xl z-10 p-4 sm:p-6 md:p-8 pt-20 md:pt-24 lg:pt-28">
      ...
      <div className="flex flex-col items-center gap-4 mt-4">
        <Button 
          ...
          className="font-headline text-xl sm:text-2xl md:text-3xl px-8 sm:px-10 md:px-12 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white border-2 border-purple-400/30"
        >
